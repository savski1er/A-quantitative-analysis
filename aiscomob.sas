...
data drg; set ais.dataei; keep maskssn drg prindiag othdiag:; run;
...
data drg; set drg; if drg=. then drg=0; run;
...
%elix (ais.datindx4,drg,datind,ais.elixh);
...
data in1.elixh; set ais.elixh; run;
...
DATA OUT1.ANALYSIS;
    ...
    SET  IN1.&CORE (KEEP=maskssn DRG DX1-DX&NUMDX);
...
/*  Output files:   C:\DATA\                               */
/***********************************************************/
LIBNAME IN1     'C:\DATA\in1';            
LIBNAME OUT1    'C:\DATA\out1';          
...
array cmvars(&nv) 	&aids_    &alcohol_  &anemdef_ &arth_     &bldloss_  &chf_     &chrnlung_ &coag_    &depress_ &dm_      
