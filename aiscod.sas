...
/*2006-2016 AHCA Outpatient cohort/
/*2006 N= 2953661
/*2007 N= 3101306
/*2008 N= 3133537
/*2009 N= 3071154
...
/*2015 N= 3029199
/*2016 N= 3063246
/*Total sample for our Outpatient cohort 32,998,747/ 
...
Data &output (keep= sys_recid year maskssn msdrg drg qtr begindate enddate admtype admitdate dischdate 
	gender sex ethnicity race age type_serv dischstat losdays adm_prior admsrc condtn 
	edhr_arr adm_time dis_time payer reason_cde zipcode ptcounty ptstate admitdiag prindiag 
	pt_status tchgs othdiag:);
set &input;
rename gender=sex;
...
Data &output (keep= sys_recid year maskssn drg qtr begindate enddate sex 
	ethnicity race age type_serv dischstat losdays adm_prior admsrc 
	condtn edhr_arr adm_time dis_time payer zipcode ptcounty ptstate
	admitdiag prindiag tchgs othdiag:);
set &input;
if age >= 18 then do;
...
%Macro datst (input,input1,input2,input3,output,output1,output2,output3);
...
proc sql;	
create table y as select a.*,b.* 
from &output a left join &input3 b
on a. maskssn= b. maskssn;
quit;   
...
%datst (ais.indexdta,inp,amb,edp,x,ais.inp1,ais.amb1,ais.edp1);
%datst (ais.indexdte,inp,amb,edp,x,ais.inp2,ais.amb2,ais.edp2);
%datst (ais.indexdti,inp,amb,edp,x,ais.inp3,ais.amb3,ais.edp3);

/***********************/

%Macro conca (input,input1,input2,output);

data &output; set &input &input1 &input2; run;

%mend conca;

%conca (ais.inp1,ais.amb1,ais.edp1,datinxa);
%conca (ais.inp2,ais.amb2,ais.edp2,datinxe);
%conca (ais.inp3,ais.amb3,ais.edp3,datinxi);
...
data &output2; set &input2; drop index_dt readm30 readm60 readm90 prindiag othdiag: ; run;
proc sql;
...
%readmx (readma,readma30,testa,readma60,testa1,readma90,testa2); 
/*R30:obs 16,unique obs 9*, *R60:obs 27,unique obs 11*, *R90:obs 42,unique obs 16*/

%readmx (readme,readme30,teste,readme60,teste1,readme90,teste2); 
...
%nodup (datindxa5,readm_alla) /*obs 362*/
%nodup (datindxe5,readm_alle) /*obs 2495*/
